...
export const OBSAH: Record<VzorecId, VzorecObsah> = {
  "01": {
    ...
    pasma: {
      ...
      dominantni:
        "Vzorec je dominantní. Strach ze ztráty je do velké míry tím, co řídí tvoje vztahové chování. Bez práce s ním se ostatní témata hýbou jen málo.",
    },
  },
  ...
  "02": {
    ...
    prozitek:
      "Základní nastavení zní, že lidé dřív nebo později využijí toho, co o tobě vědí. Nemusí jít o vědomé podezření. Je to spíš trvale zapnutá ostražitost, která běží i tam, kde je zbytečná. Sleduješ nesrovnalosti, ověřuješ si, co ti kdo řekl, a hledáš, co je za tím. Když někdo udělá něco hezkého, první otázka je, co za to. Paradox je, že ostražitost tě nechrání, ale udržuje ve stálém napětí, protože nikdy nemáš dost důkazů. Ochranných strategií bývá několik. Nepustíš nikoho blíž, než kam dosáhne škoda. Nebo ubližuješ první, aby tě nepředběhli. Nebo si držíš dokonalý přehled, protože kdo má informace, ten nebude {překvapen|překvapena}. Nejvíc to bolí u lidí, kteří ti jsou nejblíž. Právě u nich má zrada největší cenu, a proto se u nich hlídá nejvíc. Ostražitost má jednu zrádnou vlastnost: vždycky něco najde. Kdo hledá důkaz zrady, ten ho dřív nebo později objeví i v běžné nepřesnosti.",
    podTlakem:
      "Pod tlakem se ostražitost mění v obranu. Nesouhlas čteš jako útok, otázku jako výslech, zpětnou vazbu jako pokus tě shodit. Reakce přijde rychle a bývá tvrdší, než situace zaslouží, a to i vůči lidem, kteří ti nic neudělali. Cena se platí ve vztazích, ne v konfliktu. Lidé si postupně odvyknou nosit ti špatné zprávy, a tím zmizí právě to, co bys potřeboval vědět.",
    puvod:
      "Vzorec vzniká tam, kde chybělo základní bezpečí. Někdy jde o týrání, ponižování nebo zneužití, jindy o mírnější, ale opakovanou zkušenost: dospělý, který sliboval a nedodržel, který zesměšnil svěřené tajemství, který se choval nepředvídatelně. Dítě si z toho udělá rozumný závěr: bezpečně je jen tehdy, když jsem ve střehu. V dětství to byla správná strategie. V dospělosti brání přesně tomu, co potřebuješ nejvíc. Vzorec se drží proto, že se zdá ověřený. Každá zklamaná důvěra ho potvrdí, každá spolehlivá se vysvětlí jako výjimka nebo jako zatím.",
    pasma: {
      ...
      dominantni: "Vzorec je dominantní. Ostražitost je základní režim, ne výjimka. Změna začíná u jednoho vztahu, ne u postoje k lidem obecně.",
    },
  },
  ...
  "03": {
    ...
    pasma: {
      ...
      dominantni: "Vzorec je dominantní. Emoční hlad je základní tón, na kterém stojí ostatní témata. Prvním krokem není víc blízkosti, ale schopnost si o ni říct.",
    },
  },
  ...
  "04": {
    ...
    pasma: {
      ...
      dominantni: "Vzorec je dominantní. Pocit, že nepatříš, je stálý a řídí tvoje volby. Změna nepřijde z rozhodnutí, ale z opakované zkušenosti ve skupině.",
    },
  },
  ...
  "05": {
    ...
    prozitek:
      "Běžný život ti připadá jako něco, na co nemáš dost sil. Nejde o lenost ani o skutečnou neschopnost, často zvládáš mnohem víc, než si připouštíš. Jde o pocit, že bez druhého to neustojíš. Nová situace vyvolá úzkost, rozhodnutí se odkládají, dokud někdo neporadí, a i po rozhodnutí zůstává pochybnost, jestli to nebyla chyba. Vlastnímu úsudku nevěříš, a tak si ho necháváš potvrzovat. Existuje i obrácená podoba, která vypadá jako pravý opak: nezávislost tak zásadová, že nepřijmeš pomoc, ani když ji opravdu potřebuješ. Není to síla, je to stejný vzorec z druhé strany. Přijmout pomoc by totiž znamenalo připustit, že {sám|sama} nestačíš, a to je nesnesitelné. Obě podoby stojí na stejné větě: {sám|sama} na to nemám. Zrádné je, že rozhodnutí, která ti někdo potvrdí, ti jistotu nepřidají. Přidají ji jen ta, která uděláš a ustojíš {sám|sama}.",
    podTlakem:
      "Pod tlakem se rozhodování zastaví. Hledáš někoho, kdo to rozhodne za tebe, nebo se rozhodnutí vyhneš tak dlouho, až ho udělá čas. Odpovědnost se přesouvá jinam a s ní i pocit, že máš na svůj život vliv. Nejde přitom o velká rozhodnutí. Jistota se staví na malých, kterých je hodně, ne na jednom velkém, které přijde jednou za rok.",
    puvod:
      "Vzorec obvykle nevzniká z nedostatku péče, ale z jejího přebytku. Rodič, který dělal věci za tebe rychleji a lépe, který tě chránil před chybou, který dával najevo úzkost, kdykoli jsi něco {zkusil|zkusila} {sám|sama}. Dítě z toho vyvodí, že svět je nebezpečnější a ono samo méně schopné, než je pravda. Někdy působí i opak: prostředí tak nepředvídatelné, že se samostatnost nedala bezpečně vyzkoušet. Proto tenhle vzorec tak často nese pocit viny. Rodič to myslel dobře a dítě to ví; zlobit se na dobrý úmysl jde těžko.",
    pasma: {
      ...
      dominantni: "Vzorec je dominantní. Otázka, jestli to zvládneš {sám|sama}, stojí pod většinou rozhodnutí. Každé rozhodnutí, které uděláš {sám|sama}, ubírá vzorci kus síly.",
    },
  },
  ...
  "06": {
    ...
    pasma: {
      ...
      dominantni: "Vzorec je dominantní. Očekávání ohrožení je trvalé pozadí, na kterém se rozhoduješ. Zmenšuje se tím, že se ověří, ne tím, že se vysvětlí.",
    },
  },
  ...
  "07": {
    ...
    podTlakem:
      "Pod tlakem se stud změní v sebekritiku, která je tvrdší než cokoli, co by ti řekl druhý. Chybu si nesundáš ze zad. Buď se stáhneš, aby nebylo co odhalit, nebo předběhneš kritiku tím, že se shodíš {sám|sama}. Nejtěžší je, že úlevu přináší přesně to, co vzorec živí: schovat se. Každé schování potvrdí, že bylo co skrývat.",
    puvod:
      "Vzorec staví opakovaná kritika od někoho, na kom záleželo. Rodič, který srovnával, ponižoval, dával najevo zklamání nebo lásku podmiňoval. Nemuselo jít o tvrdost, stačí chlad a trvalá nespokojenost. Dítě nemá jak dojít k závěru, že problém je v dospělém. Dojde k jedinému možnému vysvětlení: je to mnou. Proto se tenhle vzorec nedá přebít úspěchem. Výkon dokazuje, co umíš, a stud mluví o tom, co jsi; ty dvě věci se míjejí.",
    pasma: {
      ...
      dominantni: "Vzorec je dominantní. Stud je základní vrstva, přes kterou se dívá na všechno ostatní. Ustupuje jedině tam, kde tě někdo uvidí a neodejde.",
    },
  },
  ...
  "08": {
    ...
    pasma: {
      ...
      dominantni: "Vzorec je dominantní. Očekávání neúspěchu předchází většině výkonových rozhodnutí. Ustoupí až po zkušenosti, kterou si nepůjde vysvětlit jako náhodu.",
    },
  },
  ...
  "09": {
    ...
    prozitek:
      "Žiješ podle toho, co chtějí druzí, a vlastní potřeby dáváš stranou tak samozřejmě, že si toho často ani nevšimneš. Konfliktu se vyhýbáš, ustupuješ, dokud to jde, a když někdy dáš přednost sobě, přijde vina. Vzniká z toho tichá nerovnováha: dáváš víc, než dostáváš, a hlavní rozhodnutí ve tvém životě jako by dělal někdo jiný. Jsou dvě varianty. Poddajnost, kdy se přizpůsobuješ ze strachu z hněvu, odvety nebo ztráty. A sebeobětování, kdy se přizpůsobuješ proto, že cítíš bolest druhých tak silně, že jinak nejde. Zvenčí to vypadá jako laskavost a často to laskavost i je. Rozdíl je v tom, že tady si to nevybíráš. Pod povrchem se přitom hromadí hněv, který se nemá kam vybít, a proto vychází nepřímo: pasivitou, otálením, únavou, tělesnými potížemi nebo nečekaným výbuchem. Pozná se to podle únavy, která nedává smysl. Když ti dojdou síly z běžného týdne, obvykle za tím není práce, ale ustupování.",
    podTlakem:
      "Pod tlakem řekneš ano dřív, než si stihneš spočítat kapacitu. Vlastní hranice zmizí první a jako poslední se přizná, že už to nejde. Vyčerpání pak nepřijde z práce, ale z toho, že se v ní nikde nepočítá s tebou. První hranice, která padne, je ta k sobě. Až potom padají ostatní a okolí si toho všimne mnohem dřív než ty.",
    puvod:
      "Za vzorcem stojí dospělý, jehož vůle nešlo bezpečně odmítnout. Rodič dominantní, nevyzpytatelný, trestající, nebo naopak křehký a nemocný, kterého nešlo zatížit. V obou případech se dítě naučilo, že mít vlastní potřebu je nebezpečné nebo sobecké. Vlastní chtění se proto raději utlumilo dřív, než se stihlo vyslovit. Proto se vlastní potřeba často nejeví jako potřeba, ale jako sobectví. Dítě se naučilo, že chtít je nebezpečné, ne že je to normální.",
    pasma: {
      ...
      dominantni: "Vzorec je dominantní. Přizpůsobení je základní režim a vlastní chtění se skoro neozve. První krok není konflikt, ale vyslovená potřeba v bezpečném vztahu.",
    },
  },
  ...
  "10": {
    ...
    pasma: {
      ...
      dominantni: "Vzorec je dominantní. Výkon je tvoje identita a zastavení se cítí jako ohrožení. Zpomalení se tady trénuje jako dovednost, ne jako předsevzetí.",
    },
  },
  ...
  "11": {
    ...
    prozitek:
      "Máš pocit, že se na tebe běžná omezení tak úplně nevztahují, a že tvoje potřeby mají přednost. Když ti někdo odporuje nebo ti něco překazí, přijde vztek, který je na situaci nepřiměřený. Vzorec má tři podoby a mohou se překrývat. Rozmazlenost, kdy si nárokuješ výjimku a do druhých se nevcítíš, protože tě to prostě nenapadne. Závislá podoba, kdy se výjimečnost pojí s očekáváním, že se o tebe někdo silnější postará, protože je to jeho povinnost. A impulzivní podoba, kdy je problém vydržet nepohodlí: těžko se odkládá potěšení, těžko se dokončuje cíl, který přestal bavit, a špatně se přestává s tím, co krátkodobě uleví. Zvenčí působí tenhle vzorec sebejistě. Uvnitř bývá pod ním něco docela jiného, nejčastěji stud nebo prázdno, které se nárokovostí přehlušuje. Nejspolehlivější stopa je vztek na maličkost. Nepřiměřená reakce na drobné omezení bývá zvenčí vidět dřív než zevnitř.",
    podTlakem:
      "Pod tlakem klesá tolerance k omezení. Pravidla, čekání a kompromis se stanou nesnesitelnými, rozhodnutí se dělají rychle a impulzivně, a následky se řeší až potom. Vztahy to obvykle odnesou dřív než výsledky. Následky přitom nese okolí dřív než ty. Právě proto se vzorec drží tak dlouho: jeho cena se platí jinde.",
    puvod:
      "Za vzorcem stojí buď absence hranic, kdy dítě dostalo všechno a nikdo mu neřekl ne, nebo naopak kompenzace: prostředí, kde bylo dítě ponižované nebo přehlížené, a výjimečnost se stala způsobem, jak to přežít. Někdy je za tím i rodič, který dítě vystavoval jako důkaz vlastní hodnoty. Ve všech variantách chyběla zkušenost, že hranice může být laskavá a přitom pevná. Obě cesty vedou na stejné místo: hranice nikdy nebyla bezpečná zkušenost. Buď chyběla úplně, nebo přišla jako ponížení.",
    pasma: {
      ...
      dominantni: "Vzorec je dominantní. Nárok a impulz předbíhají rozvahu ve většině situací. Změna začíná tím, že si všimneš ceny, kterou platí okolí.",
    },
  },
}
