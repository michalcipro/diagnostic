...
// Texty vyhodnocení vzorců pro individuální sportovce.
//
// Vychází z týmové verze (obsah-sport-tym.ts) a liší se přesně tam, kde se
// liší život individuálního sportovce: místo kabiny a sestavy nominace,
// tréninková skupina a zázemí, místo zápasu závod a start, místo lavičky
// trenér. Klinické jádro vět je s týmovou verzí doslova shodné, aby obě
// podoby zůstaly srovnatelné.
//
// Rodové tvary jsou označené {mužský|ženský} a rozvine je applyGender().

export const OBSAH_SPORT_INDIVIDUAL: Record<VzorecId, VzorecObsah> = {
  "01": {
    nazev: "Strach z opuštění",
    tema: "Ztráta zázemí a jistoty místa",
    motto: "Až přestanu podávat výkon, zůstanu {sám|sama}.",
    prozitek:
      "Někde uvnitř máš jistotu, že lidi, kteří tě ve sportu drží, nakonec neztratíš náhodou, ale zákonitě. Trenér skončí, tréninková skupina se rozpadne, svaz změní plány, zájem opadne. I v období, kdy se daří, čekáš, kdy se to zlomí. Tahle jistota nestojí na tom, co se právě děje, a proto ji nevyvrátí ani nová smlouva, ani jistá nominace. Vzniká často dřív, než si člověk pamatuje, a proto je pod ní cítit něco starého a naléhavého: pár dní bez pozornosti trenéra spustí paniku, která je na situaci zjevně příliš velká. Reakce bývá jedna ze dvou. Buď se přimkneš blíž, ověřuješ, ptáš se, žádáš ujištění, a čím víc ho dostaneš, tím kratší dobu vydrží. Nebo si naopak držíš odstup, protože co si nepustíš k tělu, to tě nemůže opustit. Obojí vypadá zvenčí jinak, ale dělá totéž: chrání tě před ztrátou a zároveň brání tomu, aby vztah s trenérem nebo zázemím zesílil natolik, že by ztrátu unesl. Poznáš to podle nepoměru: síla reakce neodpovídá tomu, co se právě stalo.",
    podTlakem:
      "Pod tlakem se zkracuje tvoje tolerance k nejistotě. Nezvednutý telefon, změněný tón na tréninku nebo pár dní bez zpětné vazby se okamžitě čtou jako začátek konce. Rozhodnutí pak neděláš podle toho, co je pro tvou kariéru dobré, ale podle toho, co udrží druhého na místě: přijmeš podmínky, které ti nesedí, nebo mlčíš tam, kde bys {měl|měla} mluvit. V rozhodující fázi závodu se to projeví opatrností, protože chyba se v téhle logice netrestá ztrátou bodu, ale ztrátou přízně.",
    puvod:
    ...
    pasma: {
      "velmi-nizka":
        "Tenhle vzorec u tebe prakticky nesvítí. Změny v zázemí tě zasáhnou, ale nedefinují, jak sportuješ.",
      nizka:
      ...
      vysoka:
        "Vzorec výrazně ovlivňuje, jak prožíváš vztahy kolem sportu a jaká rozhodnutí o kariéře děláš.",
      dominantni:
  ...
  "02": {
    ...
    pasma: {
      ...
      vysoka: "Vzorec výrazně ovlivňuje, jak blízko si trenéra i lidi ze zázemí pouštíš.",
      dominantni:
        "Vzorec je dominantní. Ostražitost je základní režim, ne výjimka. Změna začíná u jednoho vztahu, ne u postoje k okolí jako celku.",
    },
  },
  ...
  "03": {
    ...
    prozitek:
      "Tenhle vzorec se špatně popisuje, protože nemá tvar myšlenky. Je to spíš trvalý pocit prázdna a osamělosti, který nezmizí ani uprostřed zázemí, které funguje. Zajímá je výsledek, ne ty. Nikdo se nezeptá, jak ti po závodě doopravdy bylo. Nikdo tu není tak, jak bys potřeboval. Ve sportu se to snadno schová, protože prostředí odměňuje samostatnost a tichou dřinu; tvoje okolí často ani netuší, že něco chybí. Často se to pozná až podle toho, koho si vybíráš: přitahují tě lidé, kteří citově nedosáhnou tam, kam potřebuješ, a tak se prázdno potvrdí. Nebo vztah, i ten s trenérem, začne nadějně a po čase přijde zklamání, protože druhý nikdy nedá dost. Zvenčí to vypadá jako náročnost. Zevnitř je to hlad. Nejtěžší část bývá, že si o blízkost neumíš říct: buď to nepovažuješ za možné, nebo přijmout péči znamená vydat se všanc.",
    podTlakem:
    ...
    pasma: {
      ...
      vysoka: "Vzorec výrazně ovlivňuje tvoje vztahy kolem sportu i to, koho si k sobě pouštíš.",
      dominantni:
  ...
  "04": {
    ...
    motto: "Mezi ostatní nepatřím.",
    prozitek:
      "Základním pocitem je osamělost ve skupině, ne o samotě. Ve skupině stojíš mimo, i když tě nikdo nevylučuje. Existují dvě podoby a mohou se prolínat. První říká: nechtějí mě. Mezi ostatními závodníky se cítíš {nedostatečný|nedostatečná}, nevíš, o čem mluvit, ostatní ti připadají uvolněnější, a celou společnou akci přečkáváš s úlevou, až budeš moct odejít. Druhá říká: jsem jiný. Nemusí v ní být pocit méněcennosti, spíš trvalé vědomí, že do téhle party nepatříš, protože jsi z jiného těsta. Důležité je, že tenhle vzorec se týká skupin, ne blízkých vztahů. S jednotlivci, které znáš, ti může být dobře; jakmile je lidí víc, na soustředění nebo na srazu, spustí se to znovu. Dobrá zpráva je, že má úzkou působnost: když se skupina rozpadne na jednotlivé rozhovory, obvykle zmizí i on.",
    podTlakem:
    ...
    pasma: {
      ...
      nizka: "Objevuje se okrajově, v nové tréninkové skupině nebo na srazu, kde nikoho neznáš.",
      stredni: "Vzorec je aktivní. Ve skupině stojíš spíš stranou, než bys {chtěl|chtěla}.",
  ...
  "05": {
    ...
    prozitek:
      "Samostatné rozhodování ti připadá jako něco, na co nemáš dost sil. Nejde o lenost ani o skutečnou neschopnost, často zvládáš mnohem víc, než si připouštíš. Jde o pocit, že bez vedení to neustojíš. Nová situace v závodě vyvolá úzkost, rozhodnutí se odkládá, dokud nepřijde pokyn trenéra, a i po něm zůstává pochybnost, jestli to nebyla chyba. Vlastnímu úsudku nevěříš, a tak si ho necháváš potvrzovat. Existuje i obrácená podoba, která vypadá jako pravý opak: nezávislost tak zásadová, že nepřijmeš pomoc, ani když ji opravdu potřebuješ, protože přijmout ji by znamenalo připustit, že {sám|sama} nestačíš. Obě podoby stojí na stejné větě. Zrádné je, že rozhodnutí, která ti někdo potvrdí, ti jistotu nepřidají; přidají ji jen ta, která uděláš a ustojíš {sám|sama}.",
    podTlakem:
      "Pod tlakem se rozhodování zastaví. Hledáš očima trenéra, čekáš na pokyn, nebo se rozhodnutí vyhneš tak dlouho, až ho udělá čas a situace se zavře sama. Odpovědnost se přesouvá jinam a s ní i pocit, že máš na svůj výkon vliv. Nejde přitom o velká rozhodnutí; jistota se staví na malých, kterých je v závodě hodně.",
    puvod:
    ...
    pasma: {
      "velmi-nizka": "Vzorec je prakticky neaktivní. V závodě se rozhoduješ {sám|sama} a stojíš si za tím.",
      ...
      vysoka: "Vzorec výrazně ovlivňuje tvoji samostatnost v závodě i v kariéře.",
      dominantni:
  ...
  "06": {
    ...
    pasma: {
      ...
      vysoka: "Vzorec výrazně ovlivňuje, do čeho v závodě jdeš a čemu se raději vyhneš.",
      dominantni:
  ...
  "07": {
    ...
    pasma: {
      ...
      stredni: "Vzorec je aktivní. Stud se vrací a ovlivňuje, kolik ze sebe před okolím ukážeš.",
  ...
  "08": {
    ...
    podTlakem:
      "Pod tlakem přijde odklad nebo únik. Do riskantního řešení nejdeš, cíl se sníží, příležitost se pustí. Někdy naopak přijde přehnaná práce, ale bez radosti z výsledku, protože žádný výsledek nestačí na to, aby přesvědčil. Nebezpečné je, že odklad se tváří rozumně: vždycky existuje důvod, proč zrovna teď není vhodná chvíle.",
    puvod:
      "Bývá za tím prostředí, kde se výkon srovnával a srovnání vycházelo špatně. Sourozenec nebo jiný závodník, kterého dávali za vzor, oddíl, ve kterém jsi {nestačil|nestačila}, rodič, který dal najevo zklamání nebo naopak nepomohl tam, kde jsi to {potřeboval|potřebovala}. Někdy je příčinou pozdější tělesný vývoj než u vrstevníků nebo sport zvolený podle přání rodičů. Závěr o vlastních možnostech se přitom udělal v době, kdy jsi {neměl|neměla} skoro žádná data, a od té doby se už jen potvrzoval.",
    pasma: {
  ...
  "09": {
    ...
    prozitek:
      "Žiješ podle toho, co chtějí druzí, a vlastní potřeby dáváš stranou tak samozřejmě, že si toho často ani nevšimneš. Konfliktu se vyhýbáš, ustupuješ, dokud to jde, a když někdy dáš přednost sobě, přijde vina. Ve sportu je to obzvlášť zrádné, protože přizpůsobení tady vypadá jako profesionalita: trénuješ i přes bolest, mlčíš o únavě, přistoupíš na objem, který tělo neunese, a na způsob přípravy, který ti nesedí. Jsou dvě varianty. Poddajnost, kdy se přizpůsobuješ ze strachu z hněvu nebo ztráty místa. A sebeobětování, kdy se přizpůsobuješ proto, že cítíš potřeby druhých tak silně, že jinak to nejde. Zvenčí to vypadá jako pracovitost a často to pracovitost i je; rozdíl je v tom, že tady si to nevybíráš. Pod povrchem se přitom hromadí hněv, který se nemá kde vybít, a proto vychází nepřímo: pasivitou, otálením, únavou, tělesnými potížemi nebo nečekaným výbuchem.",
    podTlakem:
