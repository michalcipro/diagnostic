...
export const OBSAH_SK: Record<VzorecId, VzorecObsah> = {
  "01": {
    ...
    pasma: {
      ...
      dominantni:
        "Vzorec je dominantný. Strach zo straty je do veľkej miery tým, čo riadi tvoje vzťahové správanie. Bez práce s ním sa ostatné témy hýbu len málo.",
    },
  },
  ...
  "02": {
    ...
    pasma: {
      ...
      dominantni: "Vzorec je dominantný. Ostražitosť je základný režim, nie výnimka. Zmena sa začína pri jednom vzťahu, nie pri postoji k ľuďom všeobecne.",
    },
  },
  ...
  "03": {
    ...
    prozitek:
      "Tento vzorec sa zle opisuje, pretože nemá tvar myšlienky. Je to skôr trvalý pocit prázdna a osamelosti, ktorý nezmizne, ani keď si medzi ľuďmi, ktorí ťa majú radi. Nikto ti celkom nerozumie. Nikto sa naozaj neopýta, ako ti je. Nikto tu nie je tak, ako by si potreboval. Často sa to pozná až podľa vzťahov, ktoré si vyberáš: priťahujú ťa ľudia, ktorí citovo nedosiahnu tam, kam potrebuješ, a tak sa prázdno potvrdí. Alebo vzťah začne sľubne a po čase príde sklamanie a nuda, pretože druhý nikdy nedá dosť. Zvonku to vyzerá ako náročnosť. Zvnútra je to hlad. Najťažšia časť býva, že si o blízkosť nevieš povedať. Buď preto, že to nepovažuješ za možné, alebo preto, že prijať starostlivosť znamená vydať sa všanc. Nejde pritom o to, že by si {bol|bola} {náročný|náročná}. Ide o to, že sa o blízkosť nevieš prihlásiť, a nevyslovená potreba sa naplniť nedá.",
    podTlakem:
      "Pod tlakom sa sťahuješ. Namiesto toho, aby si sa {oprel|oprela} o ľudí okolo, prestaneš zdieľať a ponesieš to {sám|sama}, pretože kdesi vnútri máš istotu, že aj tak nikto nepríde. Tým sa prázdno potvrdí a vzorec zosilnie. Druhý pritom väčšinou nič netuší. Zvonku to vyzerá, že si {sebestačný|sebestačná}, takže sa ani nemá prečo pýtať.",
    puvod:
      "Chýbalo niečo, čo dieťa potrebuje rovnako ako jedlo: pozornosť, vrelosť, porozumenie a citlivé vedenie. Nemuselo ísť o zanedbanie. Rodičia mohli byť starostliví v tom, čo je vidieť, a nedostupní v tom, čo sa cíti. Boli zaneprázdnení, chladní, sami citovo prázdni, alebo jednoducho nevedeli byť s emóciou dieťaťa. Dieťa z toho neurobí sťažnosť, pretože inú skúsenosť nemá. Urobí z toho normu: takto to jednoducho je. Práve preto sa ten pocit tak ťažko opisuje. Nechýba spomienka na niečo zlé, chýba spomienka na niečo, čo sa nikdy nestalo.",
    pasma: {
      ...
      dominantni: "Vzorec je dominantný. Emočný hlad je základný tón, na ktorom stoja ostatné témy. Prvým krokom nie je viac blízkosti, ale schopnosť povedať si o ňu.",
    },
  },
  ...
  "04": {
    ...
    prozitek:
      "Základným pocitom je osamelosť v spoločnosti, nie o samote. V skupine stojíš mimo, aj keď ťa nikto nevylučuje. Existujú dve podoby a môžu sa prelínať. Prvá hovorí: nechcú ma. V spoločnosti sa cítiš {nedostatočný|nedostatočná}, nevieš, o čom hovoriť, ostatní ti pripadajú schopnejší, múdrejší alebo krajší, a celú akciu prečkávaš s úľavou, až budeš môcť odísť. Druhá hovorí: som iný. Nemusí v nej byť pocit menejcennosti, skôr trvalé vedomie, že do tejto skupiny nepatríš, pretože si z iného cesta. Dôležité je, že tento vzorec sa týka skupín, nie blízkych vzťahov. S jednotlivcami, ktorých poznáš, ti môže byť dobre. Len čo je ľudí viac a nie sú známi, spustí sa to znova. Dobrá správa je, že tento vzorec má úzku pôsobnosť. Keď sa skupina rozpadne na jednotlivé rozhovory, obvykle zmizne aj on.",
    podTlakem:
      "Pod tlakom sa vyhýbaš. Neprijmeš pozvanie, nevystúpiš na porade, neprihlásiš sa o slovo, nepresadíš svoj nápad v skupine. Každé vyhnutie krátkodobo uľaví a dlhodobo vzorec potvrdí, pretože skúsenosť, ktorá by ho vyvrátila, sa nemá kde stať. Vyhýbanie má vždy rozumné vysvetlenie: únava, čas, iná priorita. Práve preto sa tak dobre drží a tak ťažko si ho všimneš.",
    puvod:
      "Na rozdiel od citovej deprivácie tento vzorec obvykle nevzniká doma, ale medzi rovesníkmi. Bolo to vylúčenie zo skupiny, posmech, rodina, ktorá sa niečím nápadne líšila, sťahovanie do prostredia, kam si {nezapadol|nezapadla}, alebo len dlhé obdobie, keď si {bol|bola} v kolektíve ten posledný. Niekedy stačí jediné dosť silné obdobie. Dieťa z toho odvodí pravidlo o sebe, nie o tej skupine. Detský záver má jednu vlastnosť: nikdy sa nepreskúma. Skupina, ktorá ťa vtedy neprijala, dávno neexistuje, pravidlo o sebe platí ďalej.",
    pasma: {
      ...
      dominantni: "Vzorec je dominantný. Pocit, že nepatríš, je stály a riadi tvoje voľby. Zmena nepríde z rozhodnutia, ale z opakovanej skúsenosti v skupine.",
    },
  },
  ...
  "05": {
    ...
    pasma: {
      ...
      dominantni: "Vzorec je dominantný. Otázka, či to zvládneš {sám|sama}, stojí pod väčšinou rozhodnutí. Každé rozhodnutie, ktoré urobíš {sám|sama}, uberá vzorcu kus sily.",
    },
  },
  ...
  "06": {
    ...
    prozitek:
      "Očakávaš, že sa stane niečo zlé, a zároveň že tomu nedokážeš zabrániť. Vzorec pracuje v dvoch smeroch naraz: zväčšuje nebezpečenstvo a zmenšuje tvoju schopnosť čeliť mu. Preto nepomáha, keď si spočítaš, aké je niečo nepravdepodobné. Ohrozenie máva štyri obvyklé oblasti a nemusíš mať všetky. Zdravie a choroba, keď sleduješ telesné prejavy a hľadáš, čo znamenajú. Nebezpečenstvo zvonku, teda nehody, prepadnutie, lietanie, cestovanie. Peniaze, teda strach, že o všetko prídeš. A strata kontroly, teda obava, že sa pred ľuďmi neudržíš, zrútiš alebo zblázniš. Najnáročnejšie na tom býva, že úzkosť neubúda tým, že sa nič nestane. Každý deň bez katastrofy je len deň, keď zatiaľ neprišla. Úzkosť si pritom nemýli pravdepodobnosť s možnosťou náhodou. Kým je niečo možné, telo to počíta ako hrozbu, aj keď je to nepravdepodobné.",
    podTlakem:
      "Pod tlakom sa zužuje výber. Rozhoduješ sa tak, aby si {minimalizoval|minimalizovala} riziko, nie aby si niečo {dosiahol|dosiahla}. Príležitosti sa odmietajú skôr, než sa stihnú zvážiť, a pozornosť sa drží pri tom, čo by sa mohlo pokaziť. Vyhnutie funguje ako úľava, ktorá problém prehlbuje. Každá nevyskúšaná situácia zostane nebezpečná, pretože nedostala šancu sa vyvrátiť.",
    puvod:
      "Za vzorcom obvykle stojí dospelý, ktorý svet ukazoval ako nebezpečné miesto. Prehnane ochraňujúci rodič, ktorý varoval pred všetkým, sám žil v úzkosti a dával najavo, že vonku číha pohroma. Alebo naopak skutočné ohrozenie v detstve: vážna choroba v rodine, nehoda, chudoba, nestabilný domov. Dieťa si z toho odnesie dve presvedčenia naraz, že svet je nebezpečný a že ono naň nestačí. Dieťa si nepamätá varovania, pamätá si tón. Práve preto na to nezaberajú čísla ani štatistiky: uložilo sa to inam než rozum.",
    pasma: {
      ...
      dominantni: "Vzorec je dominantný. Očakávanie ohrozenia je trvalé pozadie, na ktorom sa rozhoduješ. Zmenšuje sa tým, že sa overí, nie tým, že sa vysvetlí.",
    },
  },
  ...
  "07": {
    ...
    podTlakem:
      "Pod tlakom sa hanba zmení na sebakritiku, ktorá je tvrdšia než čokoľvek, čo by ti povedal druhý. Chybu si nesundáš z chrbta. Buď sa stiahneš, aby nebolo čo odhaliť, alebo predbehneš kritiku tým, že sa zhodíš {sám|sama}. Najťažšie je, že úľavu prináša presne to, čo vzorec živí: schovať sa. Každé schovanie potvrdí, že bolo čo skrývať.",
    puvod:
      "Vzorec stavia opakovaná kritika od niekoho, na kom záležalo. Rodič, ktorý porovnával, ponižoval, dával najavo sklamanie alebo lásku podmieňoval. Nemuselo ísť o tvrdosť, stačí chlad a trvalá nespokojnosť. Dieťa nemá ako dôjsť k záveru, že problém je v dospelom. Dôjde k jedinému možnému vysvetleniu: je to mnou. Preto sa tento vzorec nedá prebiť úspechom. Výkon dokazuje, čo vieš, a hanba hovorí o tom, čo si; tie dve veci sa míňajú.",
    pasma: {
      ...
      dominantni: "Vzorec je dominantný. Hanba je základná vrstva, cez ktorú sa pozeráš na všetko ostatné. Ustupuje jedine tam, kde ťa niekto uvidí a neodíde.",
    },
  },
  ...
  "08": {
    ...
    pasma: {
      ...
      dominantni: "Vzorec je dominantný. Očakávanie neúspechu predchádza väčšine výkonových rozhodnutí. Ustúpi až po skúsenosti, ktorú si nepôjde vysvetliť ako náhodu.",
    },
  },
  ...
  "09": {
    ...
    pasma: {
      ...
      dominantni: "Vzorec je dominantný. Prispôsobenie je základný režim a vlastné chcenie sa skoro neozve. Prvý krok nie je konflikt, ale vyslovená potreba v bezpečnom vzťahu.",
    },
  },
  ...
  "10": {
    ...
    pasma: {
      ...
      dominantni: "Vzorec je dominantný. Výkon je tvoja identita a zastavenie sa cíti ako ohrozenie. Spomalenie sa tu trénuje ako zručnosť, nie ako predsavzatie.",
    },
  },
  ...
  "11": {
    ...
    pasma: {
      ...
      dominantni: "Vzorec je dominantný. Nárok a impulz predbiehajú rozvahu vo väčšine situácií. Zmena sa začína tým, že si všimneš cenu, ktorú platí okolie.",
    },
  },
}
