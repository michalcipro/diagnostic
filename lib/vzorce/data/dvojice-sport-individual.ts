// Popisy dvojic vzorců pro individuální sportovce.
//
// Vychází z týmové verze (dvojice-sport-tym.ts); mění se jen věty, které
// mluví o kabině, sestavě nebo spoluhráčích. Klíče se nesmí rozejít
// s ostatními variantami, hlídá to scripts/test-vzorce-sk.cjs.

export const DVOJICE_SPORT_INDIVIDUAL: Record<string, string> = {
  // ---- bezpečí ve vztazích mezi sebou ----
  "01-02": "Strach ze ztráty se tu potkává s očekáváním zrady, a to je kombinace, která drží vztah s trenérem i zázemím v trvalém napětí. Potřebuješ jistotu a zároveň jí nevěříš, takže se střídá přimknutí s ostražitostí. Druhý dostává protichůdné signály a jeho zmatená reakce pak obojí potvrdí.",
  ...
  "02-07": "Ostražitost tu chrání stud. Když si nikoho ze svého okolí nepustíš blíž, nikdo neuvidí to, co považuješ za vadu. Nedůvěra proto není jen obranou před konkurencí, ale hlavně před odhalením, a právě proto se nedá vyvrátit tím, že se někdo osvědčí.",
  "03-04": "Prázdno v blízkých vztazích se tu spojuje s pocitem, že mezi ostatní nepatříš. Chybí tedy obojí: hloubka i příslušnost. Osamělost pak nemá kde skončit, protože ani jedna z obvyklých cest, blízký člověk nebo parta, ji nezmenší.",
  ...
  "04-07": "Tyhle dva vzorce se pletou, ale nejsou totéž a spolu jsou obzvlášť těžké. Pocit, že nepatříš, se hlásí ve skupině, stud v blízkosti. Když běží oba, nezbývá bezpečné místo: ve skupině stojíš mimo a v důvěrném vztahu čekáš odhalení.",

  // ---- samostatnost mezi sebou ----
  "05-06": "Sesterská dvojice. Strach z ohrožení říká, že hra je nebezpečná, závislost na vedení říká, že na ni {sám|sama} nestačíš. Dohromady vzniká prostředí, ve kterém se nedá bezpečně rozhodnout bez pokynu, a proto se rozhodnutí buď odkládají, nebo přenášejí na trenéra.",
  ...
  "06-08": "Katastrofické scénáře tu obsluhují očekávaný neúspěch. Než na start nastoupíš, máš dopředu představu, jak to dopadne špatně, a ta představa je živější než jakákoli dosavadní zkušenost. Příprava se pak mění v obranu místo v ladění.",
  ...
  "04-08": "Pocit, že nepatříš, se tu potkává s pocitem, že nestačíš. Skupina se tím stává dvojnásob nebezpečná: nejenže tam nezapadneš, navíc se tam pozná, co neumíš. Vyhýbání se pak tváří jako volba, ale volba to není.",
  "06-07": "Očekávání ohrožení a stud spolu tvoří opatrnost, která vypadá jako povaha. Riziko nehrozí jen ze závodu, hrozí i odhalením, a proto se vyhýbáš dvakrát: nebezpečné situaci i situaci, kde by mohlo být vidět, jak ti je.",

  // ---- zaměření na druhé a hranice ----
  "01-09": "Přizpůsobení tu slouží jako pojistka proti ztrátě. Ustupuješ, abys podporu {udržel|udržela}, a čím víc ustoupíš, tím míň z tebe ve vlastní kariéře zbude. Nakonec zůstává příprava, ve které nejsi ty, a strach z její ztráty přesto neklesl.",
  ...
  "07-09": "Stud tu dává přizpůsobení smysl. Když si myslíš, že {sám|sama} o sobě nestačíš, musíš si místo ve svém zázemí zasloužit tím, co uděláš pro ostatní. Vlastní potřeba se pak nejeví jako právo, ale jako drzost.",
  "09-11": "Dva protilehlé póly hranice v jednom sportovci. Většinu času ustupuješ, a pak přijde chvíle, kdy se to zlomí do nároku nebo výbuchu, často na rozhodčí nebo nejbližší okolí. Zvenčí to působí nevypočitatelně, uvnitř je to prosté: hněv, který se dlouho nesměl ozvat, si najde cestu.",
  ...
  "02-03": "Toužíš po pochopení a zároveň čekáš zradu. To je vnitřní rozpor, který drží vztahy kolem sportu v půli cesty: dost blízko, aby bolely, ne dost blízko, aby pomohly. Otevřít se by znamenalo dát druhému do ruky přesně to, čeho se bojíš.",
  ...
  "02-04": "Nedůvěra a pocit odlišnosti spolu drží člověka mimo skupinu velmi spolehlivě. Nepatříš a zároveň nemáš důvod věřit tomu, kdo tě zve. Každé pozvání se tak stává otázkou, co za tím je.",
  "04-05": "Pocit, že nepatříš, se potkává s nedůvěrou ve vlastní síly. Skupina proto není jen nepříjemná, je i nebezpečná: {sám|sama} to neustojíš a opřít se nemáš o koho. Odtud pramení silná vazba na jednoho člověka, který dělá prostředníka mezi tebou a zbytkem skupiny.",
  ...
  "03-08": "Prázdno ve vztazích se tu sešlo s pocitem, že nestačíš ve výkonu. Nezbývá oblast, ze které by šla čerpat hodnota: v zázemí se necítíš {viděný|viděná}, na startu ne dost {dobrý|dobrá}. To je vyčerpávající kombinace, která bývá pod dlouhodobou únavou.",
  ...
  "10-11": "Nároky a nárokovost se tu spojují do velmi tvrdého nastavení. Od sebe chceš maximum a od okolí ohledy, a když se to nesejde, přijde vztek. Nejvíc to dopadá na lidi, kteří jsou nejblíž, tedy na nejbližší okolí a rodinu.",
