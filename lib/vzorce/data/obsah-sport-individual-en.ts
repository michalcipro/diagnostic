...
export const OBSAH_SPORT_INDIVIDUAL_EN: Record<VzorecId, VzorecObsah> = {
  ...
  "02": {
    ...
    pasma: {
      ...
      "vysoka":
        "The pattern strongly shapes how close you let your coach and the people in your backing.",
      "dominantni":
  ...
  "03": {
    ...
    pasma: {
      ...
      "stredni":
        "The pattern is active. The sense of not being understood returns and colours how you judge the backing around you.",
      "vysoka":
  ...
  "04": {
    ...
    podTlakem:
      "Under pressure you avoid. You do not accept the invitation, do not ask for the floor in a meeting, do not push your idea in front of the others, and at a shared occasion you stay on the edge. Every avoidance brings short-term relief and confirms the pattern in the long run, because the experience that would disprove it never gets a chance to happen. Avoidance always has a reasonable explanation: tiredness, recovery, another commitment.",
    puvod:
    ...
    pasma: {
      ...
      "nizka":
        "It shows up at the margins, in a new training group or at a squad get-together where you know nobody.",
      "stredni":
  ...
  "09": {
    ...
    motto: "In the end I do what other people want.",
    prozitek:
      "You live by what other people want, and you set your own needs aside so naturally that you often do not even notice. You avoid conflict, you give way as long as you can, and when you do occasionally put yourself first, guilt follows. In sport this is particularly insidious, because adapting looks like professionalism here: you train through pain, you say nothing about how tired you are, you agree to a training volume your body cannot handle and to a way of preparing that does not suit you. There are two variants. Compliance, where you adapt out of fear of anger or of losing your place. And self-sacrifice, where you adapt because you feel other people's needs so strongly that there is no other way. From the outside it looks like hard work, and often it is hard work. The difference is that here you are not choosing it. Meanwhile anger builds up underneath with nowhere to discharge, and so it comes out indirectly: as passivity, procrastination, tiredness, physical complaints or an unexpected outburst.",
    podTlakem:
  ...
  "11": {
    ...
    tema: "A claim to an exception, impulsivity and trouble with restriction",
    motto: "The usual rules don't apply to me.",
    prozitek:
      "You feel that the usual limits do not quite apply to you, and that your needs come first. When your coach contradicts you or thwarts you, anger comes that is out of proportion to the situation. The pattern has three forms and they can overlap. Entitlement, where you claim an exception to the rules that hold for everyone else and do not put yourself in other people's shoes, because it simply does not occur to you. The dependent form, where being exceptional pairs with the expectation that the club or the coach will take care of you, because that is their duty. And the impulsive form, where the problem is bearing discomfort: pleasure is hard to postpone, the dull part of the preparation is hard to finish, and whatever brings short-term relief is hard to stop. From the outside this pattern looks self-assured, and in a talented athlete the people around them tolerate it for a long time. Inside there is usually something quite different beneath it, most often shame or emptiness that entitlement drowns out. The most reliable trace is anger at something small.",
    podTlakem:
      "Under pressure your tolerance for restriction drops. Rules, waiting and compromise become unbearable, decisions are made fast and impulsively, and consequences are dealt with afterwards. It is usually the relationships around you that pay before the results do, and that is precisely why the pattern holds so long: its price is paid by someone other than you.",
    puvod:
