...
// Slovenské znenie textov športovej verzie. Zrkadlí obsah-sport.ts kus po kuse:
// rovnaké kľúče, rovnaké poradie, rovnaké rodové značky {mužský|ženský}.
//
// Preklad, nie prepis: vety znejú slovensky, ale odborný obsah aj poradie
// myšlienok zostávajú presne také, aké sú v češtine. Kontrolu robí
// scripts/test-vzorce-sk.cjs.

export const OBSAH_SPORT_SK: Record<VzorecId, VzorecObsah> = {
  "01": {
    nazev: "Neistá opora",
    tema: "Strach zo straty zázemia a istoty miesta",
    motto: "Keď prestanem podávať výkon, zostanem {sám|sama}.",
    prozitek:
      "Niekde vnútri máš istotu, že ľudí, ktorí ťa v športe držia, nakoniec nestratíš náhodou, ale zákonite. Tréner odíde, spoluhráč prestúpi, klub zmení plány, záujem opadne. Aj v období, keď sa darí, čakáš, kedy sa to zlomí. Táto istota nestojí na tom, čo sa práve deje, a preto ju nevyvráti ani nová zmluva, ani istá pozícia v zostave. Vzniká často skôr, než si to človek pamätá, a preto je pod ňou cítiť niečo staré a naliehavé: pár dní bez pozornosti trénera spustí paniku, ktorá je na situáciu zjavne priveľká. Reakcia býva jedna z dvoch. Buď sa primkneš bližšie, overuješ, pýtaš sa, žiadaš uistenie, a čím viac ho dostaneš, tým kratšie vydrží. Alebo si naopak držíš odstup, pretože čo si nepustíš k telu, to ťa nemôže opustiť. Oboje vyzerá zvonku inak, ale robí to isté: chráni ťa pred stratou a zároveň bráni tomu, aby vzťah s trénerom alebo tímom zosilnel natoľko, že by stratu uniesol. Spoznáš to podľa nepomeru: sila reakcie nezodpovedá tomu, čo sa práve stalo.",
    podTlakem:
      "Pod tlakom sa skracuje tvoja tolerancia k neistote. Nezdvihnutý telefón, zmenený tón na tréningu alebo pár dní bez spätnej väzby sa okamžite čítajú ako začiatok konca. Rozhodnutia potom nerobíš podľa toho, čo je pre tvoju kariéru dobré, ale podľa toho, čo udrží druhého na mieste: prijmeš rolu, ktorá ti nesadne, alebo mlčíš tam, kde by si {mal|mala} hovoriť. V koncovke sa to prejaví opatrnosťou, pretože chyba sa v tejto logike netrestá stratou bodu, ale stratou priazne.",
    puvod:
    ...
    pasma: {
      "velmi-nizka":
        "Tento vzorec u teba prakticky nesvieti. Zmeny v tíme ťa zasiahnu, ale nedefinujú, ako športuješ.",
      ...
      vysoka:
        "Vzorec výrazne ovplyvňuje, ako prežívaš vzťahy v tíme a aké rozhodnutia o kariére robíš.",
      dominantni:
  ...
  "03": {
    ...
    pasma: {
      ...
      vysoka: "Vzorec výrazne ovplyvňuje tvoje vzťahy v tíme aj to, koho si k sebe púšťaš.",
      dominantni:
  ...
  "04": {
    ...
    pasma: {
      ...
      nizka: "Objavuje sa okrajovo, v novom tíme alebo na zraze, kde nikoho nepoznáš.",
      stredni: "Vzorec je aktívny. V kabíne stojíš skôr bokom, než by si {chcel|chcela}.",
  ...
  "05": {
    ...
    prozitek:
      "Samostatné rozhodovanie ti pripadá ako niečo, na čo nemáš dosť síl. Nejde o lenivosť ani o skutočnú neschopnosť, často zvládaš oveľa viac, než si pripúšťaš. Ide o pocit, že bez vedenia to neustojíš. Nová situácia v hre vyvolá úzkosť, rozhodnutie sa odkladá, kým nepríde pokyn z lavičky, a aj po ňom zostáva pochybnosť, či to nebola chyba. Vlastnému úsudku neveríš, a tak si ho nechávaš potvrdzovať. Existuje aj obrátená podoba, ktorá vyzerá ako pravý opak: nezávislosť taká zásadová, že neprijmeš pomoc, ani keď ju naozaj potrebuješ, pretože prijať ju by znamenalo pripustiť, že {sám|sama} nestačíš. Obe podoby stoja na tej istej vete. Zradné je, že rozhodnutia, ktoré ti niekto potvrdí, ti istotu nepridajú; pridajú ju len tie, ktoré urobíš a ustojíš {sám|sama}.",
    podTlakem:
      "Pod tlakom sa rozhodovanie zastaví. Hľadáš očami lavičku, čakáš na pokyn, alebo sa rozhodnutiu vyhneš tak dlho, až ho urobí čas a situácia sa zavrie sama. Zodpovednosť sa presúva inam a s ňou aj pocit, že máš na svoj výkon vplyv. Nejde pritom o veľké rozhodnutia; istota sa stavia na malých, ktorých je v hre veľa.",
    puvod:
    ...
    pasma: {
      "velmi-nizka": "Vzorec je prakticky neaktívny. V hre sa rozhoduješ {sám|sama} a stojíš si za tým.",
      ...
      vysoka: "Vzorec výrazne ovplyvňuje tvoju samostatnosť v hre aj v kariére.",
      dominantni:
  ...
  "06": {
    ...
    pasma: {
      ...
      vysoka: "Vzorec výrazne ovplyvňuje, do čoho v hre ideš a čomu sa radšej vyhneš.",
      dominantni:
  ...
  "07": {
    nazev: "Skrytá nedostatočnosť",
    tema: "Hanba a strach, že sa pozná, kto naozaj som",
    motto: "Keby ma spoznali bližšie, prestali by si ma vážiť.",
    prozitek:
      "Hlavným pocitom je hanba. Nie vina za to, čo si {urobil|urobila}, ale hanba za to, čo si. Niekde vnútri máš presvedčenie, že je v tebe niečo chybné, a že keby to ľudia videli, odišli by. Preto sa to schováva: časti seba neukazuješ ani spoluhráčom, s ktorými tráviš viac času než s rodinou. Vzniká rozdiel medzi tým, koho tím pozná, a tým, kto si myslíš, že naozaj si. Na rozdiel od pocitu, že nepatríš do kabíny, tento vzorec silnie práve s blízkosťou: čím bližšie si niekoho pustíš, tým väčšie je riziko odhalenia. Správanie z toho plynie dvojaké a často sa strieda. Buď sa blízkosti vyhýbaš, alebo si vyberáš ľudí, ktorí ťa kritizujú, pretože ti sadnú do obrazu, ktorý o sebe máš. Pochvala sa pritom neudrží, skĺzne po povrchu; kritika zapadne presne. Rozdiel oproti zdravej sebakritike je v tom, kde sa zastaví: sebakritika skončí pri chybe, hanba pokračuje k záveru o tom, kto si.",
    podTlakem:
      "Pod tlakom sa hanba zmení na sebakritiku, ktorá je tvrdšia než čokoľvek, čo by ti povedal tréner. Chybu si nesundáš z chrbta ani po dobrom zápase. Buď sa stiahneš, aby nebolo čo odhaliť, teda nebudeš chcieť loptu v rozhodujúcej chvíli, alebo predbehneš kritiku tým, že sa zhodíš {sám|sama}. Úľavu pritom prináša presne to, čo vzorec živí: schovať sa.",
    puvod:
    ...
    pasma: {
      ...
      stredni: "Vzorec je aktívny. Hanba sa vracia a ovplyvňuje, koľko zo seba v tíme ukážeš.",
  ...
  "09": {
    ...
    prozitek:
      "Žiješ podľa toho, čo chcú druhí, a vlastné potreby dávaš bokom tak samozrejme, že si to často ani nevšimneš. Konfliktu sa vyhýbaš, ustupuješ, kým to ide, a keď niekedy dáš prednosť sebe, príde vina. V športe je to obzvlášť zradné, pretože prispôsobenie tu vyzerá ako profesionalita: trénuješ aj cez bolesť, mlčíš o únave, prijmeš rolu, ktorá ti nesadne, prispôsobíš sa štýlu hry, ktorý ti nevyhovuje. Sú dva varianty. Poddajnosť, keď sa prispôsobuješ zo strachu z hnevu alebo straty miesta. A sebaobetovanie, keď sa prispôsobuješ preto, že cítiš potreby druhých tak silno, že inak to nejde. Zvonku to vyzerá ako tímovosť a často to tímovosť aj je; rozdiel je v tom, že tu si to nevyberáš. Pod povrchom sa pritom hromadí hnev, ktorý sa nemá kde vybiť, a preto vychádza nepriamo: pasivitou, otáľaním, únavou, telesnými ťažkosťami alebo nečakaným výbuchom.",
    podTlakem:
    ...
    puvod:
      "Za vzorcom stojí dospelý, ktorého vôľu sa nedalo bezpečne odmietnuť. Rodič dominantný, nevyspytateľný, trestajúci, alebo naopak krehký a chorý, ktorého sa nedalo zaťažiť. Niekedy tréner, u ktorého sa nesúhlas trestal lavičkou. V oboch prípadoch sa dieťa naučilo, že mať vlastnú potrebu je nebezpečné alebo sebecké. Vlastné chcenie sa preto radšej utlmilo skôr, než sa stihlo vysloviť, a dodnes sa nejaví ako potreba, ale ako sebectvo.",
    pasma: {
  ...
  "11": {
    nazev: "Nárok na výnimku",
    tema: "Nárokovosť, impulzivita a problém s obmedzením",
    motto: "Na mňa bežné pravidlá neplatia.",
    prozitek:
      "Máš pocit, že sa na teba bežné obmedzenia tak celkom nevzťahujú, a že tvoje potreby majú prednosť. Keď ti tréner odporuje alebo ti niečo prekazí, príde hnev, ktorý je na situáciu neprimeraný. Vzorec má tri podoby a môžu sa prekrývať. Nárokovosť, keď si žiadaš výnimku z tímových pravidiel a do druhých sa nevcítiš, pretože ťa to jednoducho nenapadne. Závislá podoba, keď sa výnimočnosť spája s očakávaním, že sa o teba klub alebo tréner postará, pretože je to jeho povinnosť. A impulzívna podoba, keď je problém vydržať nepohodlie: ťažko sa odkladá potešenie, ťažko sa dokončuje nudná časť prípravy a zle sa prestáva s tým, čo krátkodobo uľaví. Zvonku pôsobí tento vzorec sebaisto a v talentovanom športovcovi ho okolie dlho toleruje. Vnútri býva pod ním niečo celkom iné, najčastejšie hanba alebo prázdno, ktoré sa nárokovosťou prehlušuje. Najspoľahlivejšia stopa je hnev na maličkosť.",
    podTlakem:
      "Pod tlakom klesá tolerancia k obmedzeniu. Pravidlá, čakanie a kompromis sa stanú neznesiteľnými, rozhodnutia sa robia rýchlo a impulzívne, a následky sa riešia až potom. Vzťahy v tíme to obvykle odnesú skôr než výsledky, a práve preto sa vzorec drží tak dlho: jeho cena sa platí inde než u teba.",
    puvod:
    ...
    pasma: {
      ...
      vysoka: "Vzorec výrazne ovplyvňuje tvoje reakcie na prekážky a dopadá na tím.",
      dominantni:
