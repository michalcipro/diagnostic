...
export const DIMENSIONS: DimensionDef[] = [
  { id: "A", name: { cs: "Identita a vnitřní motivace", en: "Identity and inner motivation", sk: "Identita a vnútorná motivácia" } },
  { id: "B", name: { cs: "Sebedůvěra a vnitřní dialog", en: "Confidence and inner dialogue", sk: "Sebadôvera a vnútorný dialóg" } },
  { id: "C", name: { cs: "Koncentrace a řízení pozornosti", en: "Concentration and attention control", sk: "Koncentrácia a riadenie pozornosti" } },
  { id: "D", name: { cs: "Emoční regulace a výkon pod tlakem", en: "Emotion regulation and performance under pressure", sk: "Emočná regulácia a výkon pod tlakom" } },
  { id: "E", name: { cs: "Odolnost a růstové nastavení mysli", en: "Resilience and growth mindset", sk: "Odolnosť a rastové nastavenie mysle" } },
  { id: "F", name: { cs: "Disciplína, návyky a regenerace", en: "Discipline, habits and recovery", sk: "Disciplína, návyky a regenerácia" } },
  { id: "G", name: { cs: "Vztahy, komunikace a prostředí", en: "Relationships, communication and environment", sk: "Vzťahy, komunikácia a prostredie" } },
]

// ---------- ELITE 200 ----------

export const ELITE200_FACETS: FacetDef[] = [
  { id: "A1", dimension: "A", name: { cs: "Jasnost identity a hodnot", en: "Clarity of identity and values", sk: "Jasnosť identity a hodnôt" }, items: [1, 23, 47, 70, 94, 118, 141, 165] },
  { id: "A2", dimension: "A", name: { cs: "Vnitřní motivace a smysl", en: "Intrinsic motivation and purpose", sk: "Vnútorná motivácia a zmysel" }, items: [8, 31, 55, 78, 103, 126, 149, 173] },
  { id: "A3", dimension: "A", name: { cs: "Sebehodnota nezávislá na výsledku", en: "Self-worth independent of results", sk: "Sebahodnota nezávislá od výsledku" }, items: [16, 39, 63, 87, 110, 134, 157, 185] },
  { id: "B1", dimension: "B", name: { cs: "Výkonová sebedůvěra", en: "Performance confidence", sk: "Výkonová sebadôvera" }, items: [2, 24, 48, 72, 95, 119, 142, 166] },
  { id: "B2", dimension: "B", name: { cs: "Kvalita vnitřního dialogu", en: "Quality of inner dialogue", sk: "Kvalita vnútorného dialógu" }, items: [9, 32, 57, 80, 104, 127, 151, 174] },
  { id: "B3", dimension: "B", name: { cs: "Vztah k sobě po chybě", en: "Self-relation after mistakes", sk: "Vzťah k sebe po chybe" }, items: [17, 40, 64, 88, 111, 135, 158, 187] },
  { id: "C1", dimension: "C", name: { cs: "Selektivní pozornost a odolnost vůči rušení", en: "Selective attention and resistance to distraction", sk: "Selektívna pozornosť a odolnosť voči rušeniu" }, items: [3, 25, 49, 73, 96, 120, 143, 167] },
  { id: "C2", dimension: "C", name: { cs: "Znovuzaměření a rutiny pozornosti", en: "Refocusing and attention routines", sk: "Znovuzameranie a rutiny pozornosti" }, items: [10, 33, 58, 81, 105, 128, 152, 175] },
  { id: "C3", dimension: "C", name: { cs: "Přítomný okamžik a proces", en: "Present moment and process", sk: "Prítomný okamih a proces" }, items: [18, 42, 65, 89, 112, 136, 159, 189] },
  { id: "D1", dimension: "D", name: { cs: "Vnímání tělesných signálů", en: "Awareness of bodily signals", sk: "Vnímanie telesných signálov" }, items: [4, 26, 51, 74, 97, 121, 144, 168] },
  { id: "D2", dimension: "D", name: { cs: "Regulace aktivace a techniky", en: "Arousal regulation and techniques", sk: "Regulácia aktivácie a techniky" }, items: [11, 35, 59, 82, 106, 129, 153, 177] },
  { id: "D3", dimension: "D", name: { cs: "Výzva vs. hrozba a jednání pod tlakem", en: "Challenge vs. threat and acting under pressure", sk: "Výzva vs. hrozba a konanie pod tlakom" }, items: [19, 43, 66, 90, 113, 137, 160, 191] },
  { id: "E1", dimension: "E", name: { cs: "Růstové přesvědčení", en: "Growth beliefs", sk: "Rastové presvedčenie" }, items: [5, 28, 52, 75, 98, 122, 145, 170] },
  { id: "E2", dimension: "E", name: { cs: "Vytrvalost a dlouhodobé úsilí", en: "Persistence and long-term effort", sk: "Vytrvalosť a dlhodobé úsilie" }, items: [12, 36, 60, 83, 107, 130, 154, 179] },
  { id: "E3", dimension: "E", name: { cs: "Zpracování neúspěchu a zpětné vazby", en: "Processing setbacks and feedback", sk: "Spracovanie neúspechu a spätnej väzby" }, items: [20, 44, 67, 91, 114, 138, 162, 193] },
  { id: "F1", dimension: "F", name: { cs: "Seberegulace a konzistence", en: "Self-regulation and consistency", sk: "Sebaregulácia a konzistencia" }, items: [6, 29, 53, 76, 99, 123, 147, 171] },
  { id: "F2", dimension: "F", name: { cs: "Spánek a regenerace", en: "Sleep and recovery", sk: "Spánok a regenerácia" }, items: [14, 37, 61, 84, 108, 132, 155, 181] },
  { id: "F3", dimension: "F", name: { cs: "Energie a životní styl", en: "Energy and lifestyle", sk: "Energia a životný štýl" }, items: [21, 45, 68, 92, 115, 139, 163, 195] },
  { id: "G1", dimension: "G", name: { cs: "Komunikace a psychologické bezpečí", en: "Communication and psychological safety", sk: "Komunikácia a psychologické bezpečie" }, items: [7, 30, 54, 77, 102, 125, 148, 172] },
  { id: "G2", dimension: "G", name: { cs: "Hranice a asertivita", en: "Boundaries and assertiveness", sk: "Hranice a asertivita" }, items: [15, 38, 62, 85, 109, 133, 156, 183] },
  { id: "G3", dimension: "G", name: { cs: "Sociální opora a prostředí", en: "Social support and environment", sk: "Sociálna opora a prostredie" }, items: [22, 46, 69, 93, 117, 140, 164, 197] },
]
